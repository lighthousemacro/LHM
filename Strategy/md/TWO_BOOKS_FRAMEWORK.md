...
## Framework-Driven Sizing (Core)

### Entry Framework

The framework-driven sleeve requires convergence across the three-engine framework:
...
Every framework-driven sleeve position has TWO stops:
...
When the framework-driven sleeve is defensive (MRI > +1.0) and regime multipliers compress position sizes, clear technical trends can still exist. The technical sleeve provides a structured way to follow price when macro is uncertain but trends are evident.
...
Three components, 4 points each. Clean 2:1 ratio to framework-driven sleeve's 24 points.
...
**The key insight:** A Technical Book position can graduate to framework-driven sleeve treatment when fundamental drivers emerge.
...
- Size up to framework-driven sleeve weights (if conviction score supports)
- Shift to framework-driven sleeve stop framework (thesis + price stops)
- Extend holding period expectation

### Scenario: framework-driven sleeve Entry → Macro Uncertainty

1. Enter position in framework-driven sleeve (thesis-driven)
2. Thesis plays out partially
3. MRI deteriorates, framework-driven sleeve goes defensive
...
- framework-driven sleeve: 50-100% allocation
- technical sleeve: 0-50% allocation
- **Core takes priority for capital allocation**

### When Core is Defensive (MRI > +1.0)

- framework-driven sleeve: Reduced exposure (regime multiplier 0.3x or lower)
- technical sleeve: Can expand to 50% if setups exist
- **Technical provides a way to stay engaged without violating macro discipline**

### Capital Allocation Priority

1. framework-driven sleeve positions with both thesis AND technical confirmation
2. framework-driven sleeve positions with thesis (technical neutral)
3. technical sleeve positions with strong scores
4. Cash
...
**The framework-driven sleeve is NOT:**
...
| Attribute | framework-driven sleeve | technical sleeve |
|-----------|-----------|-------------------|
