...
FRED_CURATED = {
    ...
    "RSGCSN": "Retail Sales General Merchandise NSA",
    "RSGMS": "Retail Sales General Merchandise Stores SA",
    "RSDBS": "Retail Sales Food and Beverage Stores SA",
    "RSMSR": "Retail Sales Miscellaneous Store Retailers SA",
    ...
    # ===== PILLARS 8/9/10 (MONETARY MECHANICS) - TV Money Category Addition Mar 2026 =====
    ...
    "FEDTARMD": "Federal Funds Target Rate Midpoint",
    "FEDTARMDLR": "Federal Funds Target Rate Midpoint Lower Range",
    "IOER": "Interest on Excess Reserves Discontinued",
    "IORR": "Interest on Required Reserves Discontinued",

    # Funding Rate Details
    "SOFRVOL": "SOFR Transaction Volume",
    "SOFR30DAYAVG": "SOFR 30-Day Average",
    "SOFRINDEX": "SOFR Index",
    "EFFRVOL": "EFFR Transaction Volume",
    "OBFRVOL": "OBFR Transaction Volume",
    "TGCRRATE": "Tri-Party General Collateral Rate",
    "SRFTSYD": "Standing Repo Facility Total Amount",

    # Fed Balance Sheet (H.4.1 Weekly)
    "WRESBAL": "Reserve Balances with Federal Reserve Banks",
    "WLRRAL": "Loans Reverse Repurchase Agreements Liquidity Swaps",
    "WRBWFRBL": "Reserve Bank Credit Total",
    "WLCFLL": "Loans Credit Facility Liquidity Lending",
    "WLODLL": "Loans Other Dealer Lending",
    "WLCFLPCL": "Loans Primary Credit Lending",
    "WLCFOCEL": "Loans Other Credit Extensions Lending",
    "WSHOSHO": "Securities Held Outright Total",
    "WSHOTSL": "Securities Held Outright Treasury Securities",
    "WSHOBL": "Securities Held Outright Treasury Bills",
    "WSHOMCB": "Securities Held Outright MBS",
    "WSHOFADSL": "Securities Held Outright Federal Agency Debt",
    "WSHONBNL": "Securities Held Outright Notes and Bonds Nominal",
    "WSHONBIIL": "Securities Held Outright Notes and Bonds Inflation-Indexed",
    "WSHOICL": "Securities Held Outright Inflation Compensation",
    "WFCDA": "Federal Reserve Currency in Circulation and Deposits",
    "TREAST": "Treasury Securities Held by Fed",
    "WORAL": "Other Reserve Assets and Loans",
    "WDTGAL": "Deposits Treasury General Account Liability",
    "WLTLECL": "Total Liabilities and Equity Capital",
    "WLAD": "Liquidity and Credit Absorption Deposits",
    "WDFOL": "Deposits Foreign Official",
    "WGCAL": "Gold Certificate Account",
    "WCTCL": "Capital Total Capital",
    "WABPL": "Assets Below Par Losses",
    "WACL": "Fed Total Assets Consolidated",
    "WLCFLSCL": "Loans Secondary Credit Lending",
    "WLCFLSECL": "Loans Seasonal Credit Lending",
    "WLDLCL": "Loans Discount Window",
    "WLDACLC": "Loans All Credit Liquidity Facilities",
    "WLFN": "Loans Float Net",
    "WLRRAFOIAL": "Loans RRP Foreign Official International",
    "WRESCRT": "Reserve Balances on Deposit Credits",
    "WSRLL": "System Open Market Account Repos Lending",
    "WUDSHO": "Unamortized Discounts on Securities",
    "WUPSHO": "Unamortized Premiums on Securities",
    "WAOAL": "All Other Assets",
    "WCBLSA": "Central Bank Liquidity Swap Arrangements",
    "WCPCA": "Coin and Currency in Process",
    "WCPIL": "Coin in Process Interdistrict Lending",
    "WCSL": "Capital Surplus",
    "WOSDRL": "Other Supplementary Discount Rate Lending",
    "WPCLC": "Preferred Capital Lending Credit",
    "H41RESPPAAENWW": "Fed Earnings Remittances",
    "H41RESPPAADHNWW": "Fed Discount Window Holdings",
    "H41RESPPAABNWW": "Fed Balance Sheet Detail",
    "H41RESPPAAC2HNWW": "Fed Commercial Holdings",
    "H41RESPPAATAL2HNWW": "Fed Total Assets Loans",
    "H41RESH4ENWW": "Fed H.4.1 Earnings",
    "RESPPANWW": "Reserve Balances Net of Overdrafts",
    "RESPPLLOPNWW": "Loans Outstanding Primary Credit",

    # RRP/Repo Details
    "RRPONTSYAWARD": "RRP Award Rate",
    "RRPONTTLD": "RRP Total Lending",
    "RPONTSYD": "Repo Overnight Treasury Securities",
    "RPONTTLD": "Repo Total Lending",
    "RPONMBSD": "Repo Mortgage-Backed Securities",
    "WREPO": "Fed Repo Operations",
    "REP15": "15-Day Repo",
    "RREP15": "15-Day Reverse Repo",

    # Money Supply
    "M1SL": "M1 Money Stock",
    "WM1NS": "M1 Weekly Not Seasonally Adjusted",
    "WM2NS": "M2 Weekly Not Seasonally Adjusted",
    "M2V": "Velocity of M2 Money Stock",
    "M1V": "Velocity of M1 Money Stock",
    "M2REAL": "Real M2 Money Stock",
    "M1REAL": "Real M1 Money Stock",
    "M2MSL": "M2 Money Stock Monthly",
    "BOGMBASE": "Monetary Base Total",
    "BOGMBASEW": "Monetary Base Weekly",
    "BOGMBBM": "Monetary Base Board of Governors Monthly",
    "MBCURRCIR": "Monetary Base Currency in Circulation",
    "CURRCIR": "Currency in Circulation",
    "WCURCIR": "Weekly Currency in Circulation",
    "CURRSL": "Currency Component of M1",
    "DEMDEPSL": "Demand Deposits",
    "AMBNS": "Adjusted Monetary Base Not Seasonally Adjusted",
    "AMBSL": "Adjusted Monetary Base",
    "MBST": "Monetary Base St. Louis Adjusted",
    "REQRESNS": "Required Reserves",
    "WIMFSL": "IMF Fund Reserves",
    "SBASENS": "Small Time Deposits",
    ...
    "STLFSI2": "St. Louis Financial Stress Index v2",
    "STLFSI3": "St. Louis Financial Stress Index v3",

    # Credit Spreads & Total Return Indices
    "BAA10Y": "Baa Corporate Bond Spread vs 10Y Treasury",
    "AAA10Y": "Aaa Corporate Bond Spread vs 10Y Treasury",
    "BAA10YM": "Baa Corporate Spread Monthly",
    "AAA10YM": "Aaa Corporate Spread Monthly",
    "BAAFFM": "Baa Corporate Spread vs Fed Funds Monthly",
    "AAAFF": "Aaa Corporate Spread vs Fed Funds",
    "BAAFF": "Baa Corporate Spread vs Fed Funds",
    "BAMLHYH0A0HYM2TRIV": "ICE BofA HY Total Return Index",
    "BAMLHYH0A1BBTRIV": "ICE BofA BB Total Return Index",
    "BAMLHYH0A2BTRIV": "ICE BofA B Total Return Index",
    "BAMLHYH0A3CMTRIV": "ICE BofA CCC Total Return Index",
    "BAMLCC0A0CMTRIV": "ICE BofA IG Total Return Index",
    "BAMLCC0A1AAATRIV": "ICE BofA AAA Total Return Index",
    "BAMLCC0A2AATRIV": "ICE BofA AA Total Return Index",
    "BAMLCC0A3ATRIV": "ICE BofA A Total Return Index",
    "BAMLCC0A4BBBTRIV": "ICE BofA BBB Total Return Index",
    "BAMLHE00EHYITRIV": "ICE BofA HY Effective Yield Total Return",
    "DAAA": "Moody's Aaa Corporate Bond Yield",
    "DPRIME": "Bank Prime Loan Rate",
    "PRIME": "Bank Prime Rate",

    # Bank Lending & Credit
    "TOTBKCR": "Total Bank Credit",
    "TOTLL": "Total Loans and Leases at Commercial Banks",
    "LOANS": "Loans at Commercial Banks",
    "DPCREDIT": "Depository Institution Credit",
    "RMFSL": "Revolving Credit at Money Market Funds",
    "DPSACBW027SBOG": "Deposits All Commercial Banks Weekly",
    "TASACBW027SBOG": "Total Assets All Commercial Banks Weekly",
    "CASACBW027SBOG": "Cash Assets All Commercial Banks Weekly",
    "CARACBW027SBOG": "Cash and Reserves All Commercial Banks Weekly",
    "TLAACBW027SBOG": "Total Loans All Commercial Banks Weekly",
    "TLAACBM027SBOG": "Total Loans All Commercial Banks Monthly",
    "CCLACBW027SBOG": "Credit Card Loans All Commercial Banks Weekly",
    "TMBACBW027SBOG": "Treasury and MBS All Commercial Banks Weekly",
    "RREACBW027SBOG": "Real Estate Loans All Commercial Banks Weekly",
    "RHEACBW027SBOG": "Residential RE Loans All Commercial Banks Weekly",
    "RHEACBM027SBOG": "Residential RE Loans All Commercial Banks Monthly",
    "ODSACBW027SBOG": "Other Deposits All Commercial Banks Weekly",
    "SBCACBW027SBOG": "Small Business C&I Loans All Commercial Banks Weekly",
    "CASLCBW027SBOG": "Cash Large Commercial Banks Weekly",
    "CASACBQ158SBOG": "Cash Assets All Commercial Banks Quarterly",
    "RSBKCRNS": "Real Total Bank Credit Not Seasonally Adjusted",
    "CREACBM027NBOG": "CRE Loans All Commercial Banks Monthly",

    # Loan Officer Survey Detail
    "DRTSCIS": "SLOOS Net Pct Tightening C&I Loans Small Firms",
    "DRSDCILM": "SLOOS Demand for C&I Loans",

    # Delinquency & Charge-Off Rates
    "DRBLACBS": "Delinquency Rate Business Loans All Banks",
    "DRSREACBS": "Delinquency Rate Real Estate All Banks",
    "DRCRELEXFACBS": "Delinquency Rate CRE Ex-Farmland All Banks",
    "DRCCLT100S": "Delinquency Rate CC Top 100 Banks SA",
    "DRSFRMT100S": "Delinquency Rate Mortgage Top 100 Banks SA",
    "CORCCACBS": "Net Charge-Off Rate Credit Card All Banks",
    "CORCCT100S": "Net Charge-Off Rate Credit Card Top 100 Banks",

    # Volatility
    "VXVCLS": "CBOE VIX of VIX VVIX",
    "GVZCLS": "CBOE Gold ETF Volatility Index",
    "OVXCLS": "CBOE Crude Oil Volatility Index",
    "VXOCLS": "CBOE S&P 100 Volatility Index",
    "VXTYN": "CBOE Treasury Note Volatility Index",

    # Treasury Yields & Bills
    "DGS3": "3Y Treasury",
    "DGS7": "7Y Treasury",
    "DGS20": "20Y Treasury",
    "DTB3": "3-Month Treasury Bill Secondary Market",
    "DTB6": "6-Month Treasury Bill Secondary Market",
    "DTB1YR": "1-Year Treasury Bill Secondary Market",
    ...
    "TREAS10Y": "10-Year Treasury Rate",
    "IRLTLT01USM156N": "Long-Term Government Bond Yields 10Y OECD",
    ...
    "T5YIEM": "5-Year Breakeven Monthly",
    "T7YIEM": "7-Year Breakeven Inflation",
    "T10YIEM": "10-Year Breakeven Monthly",
    "T20YIEM": "20-Year Breakeven Inflation",
    ...
    "DCPN3M": "3-Month Nonfinancial Commercial Paper Rate",
    "RIFSPPNAAD90NB": "90-Day AA Financial CP Rate",
    "RIFSPPNA2P2D90NB": "90-Day A2/P2 Nonfinancial CP Rate",
    "IR3TED01USM156N": "3-Month TED Spread",
    "CPFF": "Commercial Paper Funding Facility",

    # ICE Swap Rates
    "ICERATES1100EUR10Y": "ICE Swap Rate EUR 10Y",
    "ICERATES1200EUR30Y": "ICE Swap Rate EUR 30Y",
    "ICERATES1200EUR5Y": "ICE Swap Rate EUR 5Y",
    "ICERATES1100EUR20Y": "ICE Swap Rate EUR 20Y",
    "ICERATES1100USD1Y": "ICE Swap Rate USD 1Y",
    "ICERATES1100USD3Y": "ICE Swap Rate USD 3Y",
    "ICERATES1100USD4Y": "ICE Swap Rate USD 4Y",
    "ICERATES1100USD5Y": "ICE Swap Rate USD 5Y",
    "ICERATES1100USD30Y": "ICE Swap Rate USD 30Y",

    # Flow of Funds & Balance Sheet
    "BOGZ1FL072052006Q": "Total Net Worth Nonfinancial Corporate",
    "BOGZ1FL403069330A": "Money Market Fund Total Assets Annual",
    "BOGZ1FL403069330Q": "Money Market Fund Total Assets Quarterly",
    "BOGZ1FL073161113Q": "Nonfinancial Corporate Business Debt Securities",
    "BOGZ1LM152010005Q": "Households Total Financial Assets",
    "MMMFFAQ027S": "Money Market Funds Total Financial Assets Quarterly",
    "MMMFTAQ027S": "Money Market Funds Total Assets Quarterly",
    "IIPUSNETIQ": "US Net International Investment Position",
    "QFRTCASHINFUSNO": "Quarterly Financial Report Cash Nonfin",
    "QBPBSTAS": "Quarterly Banking Profile Total Assets",
    "QUSPAM770A": "Total Credit to Private Non-Financial Sector",
    "X10AICBBDBT": "Total Credit to Private Non-Fin BIS",

    # Consumer Debt Detail
    "SUBLPDHMDENQ": "Subprime Auto Delinquency NY Fed HHD",
    "CDCABSHNO": "Consumer Debt Total",
    "STDSL": "Student Loans Outstanding",
    "FEDDT": "Federal Debt Total Public Debt",

    # Household
    "GPSAVE": "Gross Private Savings",
    "GPDIC1": "Real Gross Private Domestic Investment",
    "COMPOUT": "Business Sector Compensation Per Hour",

    # Confidence
    "CSCICP03USM665S": "Consumer Confidence Indicator OECD",

    # Other / Misc
    "SPASTT01USM661N": "Share Prices All Shares",
    "MDLM": "Monetary Financial Institutions Deposits Long and Medium",
    "DDDM01USA156NWDB": "Domestic Deposit Money Banks Assets",
    "DDSI02USA156NWDB": "Domestic Saving Investment Ratio",
    "DDDI06USA156NWDB": "Domestic Deposit Money Banks Deposits",
    "DDDM03USA156NWDB": "Domestic Deposit Money Banks Reserves",
    "DDEM01USA156NWDB": "Domestic Deposit Money Banks Excess Reserves",
    "DDOM01USA644NWDB": "Domestic Money Supply",
    "M14062USM027NNBR": "Money Stock Historical",
    "M13009USM156NNBR": "Commercial Bank Deposits Historical",
    "M1329AUSM193NNBR": "Money Supply M1 Historical",
    "M1490AUSM157SNBR": "Money Supply M2 Historical",
    "M13002US35620M156NNBR": "Money Market Fund Assets Historical",
    "A14187USA163NNBR": "National Bank Deposits Historical",
    "ABCOMP": "ABC News Consumer Comfort Index",
    "INTDSRUSM193N": "Interest Rates Discount Rate US",
    "MABMM301USA657S": "OECD Broad Money Annual",
    "MABMM301USM189S": "OECD Broad Money Monthly",
    "MANMM101USM189S": "OECD Narrow Money Monthly",
    "MZMV": "MZM Money Stock Velocity",
    "RKNANPUSA666NRUG": "Gross National Savings Rate",
    "MYAGM2USM052S": "M2 to GDP Ratio",
    "GDTCBW": "Treasury Bonds Held by Banks",
    "TOTLCA": "Total Consumer Loans Outstanding",
    "CNCF": "Corporate Net Cash Flow",
    "DTP10J28": "Treasury Auction 10Y High Yield",
    "DTP5A23": "Treasury Auction 5Y High Yield",
    "WRMFSL": "Retail Money Market Funds",
    "SWPT": "Fed Swap Facility Total",
    "TREASURY": "Treasury Securities Outstanding",
}
