...
**Still open:**
- **Crypto (optional extras)** — `CRYPTO_BTC_PRICE` only keeps ~6mo history (free fetcher window); SLI (stablecoin) needs the `STABLE_*` fetch repaired. CDLI covers the core liquidity read; these are nice-to-haves.
