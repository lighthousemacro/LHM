...
**Pascal's role.** Smart student, not peer. He interrupts with the dumb question; each interruption becomes a teaching moment. Framework readings sent ahead so he isn't catching up in the booth.

---

## Episode 1 — The Diagnostic Dozen: How We See

**Cold open.** Most macro is reaction dressed up as analysis. LHM inverts the order: framework first, data feeds the framework, interpretation falls out.
...
2. Labor flows leading the unemployment rate (historical)
3. Clean pillar table (12 pillars, indices, lead times)
...
2. CLG historical chart
3. Sentiment-Structure Divergence at a known turning point
...
**Companion visuals (3):**
1. Two Books schematic
2. Tier-sizing diagram
3. Regime multiplier × MRI table
...
2. **Pascal as smart student.** Each interruption is a teaching moment. Send framework readings ahead.
3. **Don't read the Substack series aloud.** Audio rewards conversational cadence: more analogies, more stopping to explain why.
4. **No current positioning, current views, current trades.** Those belong on Substack. This series is the foundation people read *before* the Substack.
5. **Nine companion visuals total.** Three per episode. Produced LHM-side, handed to Pascal for the Substack post accompanying each release.
