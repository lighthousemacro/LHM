"""
Build the Pillar 1 Labor chartbook PDF.

Stitches every PNG in this folder (sorted by filename) into a single
branded PDF at the pillar root: Pillar_01_Labor_Chartbook.pdf

Run daily after chart regeneration:
...
PILLAR_NAME = "LABOR"
PILLAR_NUMBER = 1
PILLAR_SUBTITLE = "The Source Code"

CHARTS_DIR = Path(__file__).parent
PILLAR_DIR = CHARTS_DIR.parent
OUTPUT_PDF = PILLAR_DIR / f"Pillar_{PILLAR_NUMBER:02d}_{PILLAR_NAME.title()}_Chartbook.pdf"
