...
```
Full-width dashed ghost line. Use `#D1D1D1` (Ref) for standard zero lines.
...
THEME = {
    ...
    'muted': '#555555',
    'spine': '#898989',          # Doldrums
    'zero_line': '#D1D1D1',      # Ref — ghost reference line
    'recession': 'gray',
...
| **Ref** | `#D1D1D1` | D1+D1 | Zero lines, ghost references |
