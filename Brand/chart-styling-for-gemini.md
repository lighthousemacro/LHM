...
### Zero Line (Doldrums)
```python
ax.axhline(0, color='#898989', linewidth=0.8, alpha=0.5, linestyle='--')
```
Full-width dashed line. Use `COLORS['doldrums']` (`#898989`) for standard charts.
...
THEME = {
    ...
    'box_edge': '#00BBFF',       # Annotation box edge (note: currently hardcoded as Ocean in helper)
    'legend_bg': '#0f1f38',
    'legend_fg': '#e6edf3',
    'mode': 'dark',
}
...
THEME = {
    ...
    'secondary': '#FF6723',      # Dusk
    'tertiary': '#00BBFF',       # Sky (pops against white bg)
