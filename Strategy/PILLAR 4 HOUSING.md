...
### I. ALTERNATIVE & HIGH-FREQUENCY DATA (The Edge)

These indicators provide real-time or unconventional signals that traditional housing data misses. High-frequency data allows detection of turns weeks before official releases.

#### Real-Time Market Indicators

| **Indicator** | **Source** | **Frequency** | **Lead/Lag** | **Interpretation** |
|---|---|---|---|---|
| **Redfin Homebuyer Demand Index** | Redfin | Weekly | **Leads sales 4-6 wks** | Touring/offer activity proxy |
| **Redfin Bidding War Rate** | Redfin | Monthly | Coincident | Competition intensity |
| **Altos Market Action Index** | Altos/HousingWire | Weekly | **Leads price turns 4-8 wks** | Score >30 = seller's, <30 = buyer's |
| **Google Trends: "Houses for Sale"** | Google | Weekly | **Leads MBA 2-4 wks** | Search intent proxy |
| **Google Trends: "Mortgage Calculator"** | Google | Weekly | Leads purchase apps 2-4 wks | Rate sensitivity proxy |
| **Google Trends: "Sell My House"** | Google | Weekly | Coincident | Seller intention signal |
| **Zillow For-Sale Listing Views** | Zillow | Monthly | Leads sales 4-6 wks | Online engagement proxy |
| **ShowingTime Index** | ShowingTime | Monthly | **Leads sales 4-6 wks** | Physical showing activity |
| **Mortgage Lock Volume** | Optimal Blue | Daily | **Leads closings 45-60 days** | Real-time origination gauge |

#### Commodity & Input Price Signals

| **Indicator** | **Source** | **Frequency** | **Interpretation** |
|---|---|---|---|
| **Lumber Futures** | CME (LBS) | Daily | Construction cost signal; leads housing starts by 3-6 months |
| **Copper Futures** | CME (HG) | Daily | Industrial/construction activity proxy (less housing-specific) |
| **Gypsum & Wallboard PPI** | BLS | Monthly | Interior finishing cost signal |
| **Ready-Mix Concrete PPI** | BLS | Monthly | Foundation/structural cost |
| **Construction Materials PPI** | BLS | Monthly | Broad construction input costs |
| **Softwood Lumber PPI** | BLS | Monthly | Domestic lumber price trends |
| **Flat Glass PPI** | BLS | Monthly | Window/glazing cost signal |

#### Cross-Asset Housing Proxies

| **Indicator** | **Source** | **Frequency** | **Interpretation** |
|---|---|---|---|
| **XHB (SPDR Homebuilders ETF)** | Market | Daily | Builder equity sentiment; **leads fundamentals 3-6 mo** |
| **ITB (iShares Homebuilders ETF)** | Market | Daily | Cap-weighted builder sentiment |
| **VNQ (Vanguard Real Estate ETF)** | Market | Daily | Broad REIT performance |
| **REM (iShares Mortgage REIT)** | Market | Daily | Mortgage REIT health |
| **AMT, INVH, AMH** | Market | Daily | Single-family rental REIT proxies |
| **MBB (iShares MBS ETF)** | Market | Daily | Agency MBS price/spread proxy |
| **VMBS (Vanguard MBS ETF)** | Market | Daily | Agency MBS (complement to MBB) |
| **Bloomberg US MBS Index** | Bloomberg | Daily | Institutional MBS benchmark |
| **MBS OAS (Option-Adjusted Spread)** | Bloomberg/ICE | Daily | MBS credit and prepay risk pricing |
| **Fed MBS Holdings** | Federal Reserve H.4.1 | Weekly | QT pace and MBS runoff |

#### Institutional & Structural Indicators

| **Indicator** | **Source** | **Frequency** | **Interpretation** |
|---|---|---|---|
| **U-Haul Growth Index** | U-Haul | Annual | Migration flow gauge |
| **USPS Change of Address** | USPS/Postal data | Monthly | Mover activity |
| **IRS Migration Data** | IRS SOI | Annual (lag) | State-to-state flows with income data |
| **Remote Work Share** | BLS/Census | Monthly/Quarterly | Work-from-home impact on geography |
| **iBuyer Purchase Volume** | Redfin/Opendoor filings | Monthly/Quarterly | Algorithmic buying activity |
| **SFR REIT Acquisitions** | INVH, AMH filings | Quarterly | Institutional SFR demand |
| **Foreign Buyer Volume** | NAR International | Annual | Cross-border capital flows |
| **AirDNA Short-Term Rental Supply** | AirDNA | Monthly | STR saturation in key markets |

#### Derived Alternative Metrics

| **Metric** | **Formula** | **Threshold** | **Signal** |
|---|---|---|---|
| **XHB vs S&P 500 (3M Rel Strength)** | XHB Return - SPX Return (63d) | >+5% | Housing leading broad market |
| **XHB vs XLY (vs Consumer Disc)** | XHB Return - XLY Return (63d) | <-5% | Housing lagging consumer |
| **Lumber-to-Gold Ratio** | Lumber / Gold | Declining trend | Risk-off in cyclicals |
| **Lumber YoY%** | Current - Year Ago | <-20% | Construction demand weak |
| **MBS Spread Change** | Current OAS - 6M Ago OAS | >+20 bps | MBS stress building |
| **Fed MBS Runoff Rate** | Monthly MBS Reduction | Accelerating | Tightening financial conditions |
| **Google Trends Momentum** | "Houses for Sale" 4W Avg vs 12W Avg | Cross above | Search demand turning |
| **Bidding War Rate** | Current vs 6M Avg | <-10 ppts | Competition fading rapidly |

---

### J. POLICY & REGULATORY ENVIRONMENT

Government policy is a structural driver of housing markets. Tax, regulatory, trade, and GSE policy all shape the playing field.

| **Policy Area** | **Key Variables** | **Impact Channel** | **Lead Time** |
|---|---|---|---|
| **Mortgage Interest Deduction** | SALT cap, standard deduction threshold | Effective cost of homeownership | Structural |
| **SALT Deduction Cap** | Currently $10K (per TCJA 2017) | High-tax state affordability | Structural |
| **First-Time Buyer Credits** | On/off, amount, phase-out | Marginal demand catalyst | 3-6 months |
| **FHA/VA/USDA Loan Limits** | Annual adjustments | Access to government-backed financing | Annual |
| **Conforming Loan Limits** | FHFA (currently $806,500) | GSE financing access | Annual |
| **GSE Status (Fannie/Freddie)** | Conservatorship, IPO risk | Mortgage market structure | Structural |
| **Fed MBS Purchases/Runoff** | QE/QT policy | Mortgage rate floor/ceiling | 1-4 weeks |
| **Zoning & Land Use** | State/local regulations | Supply constraints | Structural |
| **Tariffs on Building Materials** | Steel, lumber, copper, fixtures | Construction costs, +$10-20K/home | 3-12 months |
| **Immigration Policy** | Construction labor supply (30%+ immigrant) | Labor costs, construction capacity | 6-18 months |
| **Institutional SFR Regulation** | Purchase bans, tax disincentives | Institutional demand for SFR | 6-12 months |
| **Rent Control / Stabilization** | State/local policies | Rental supply incentives | 12-24 months |
| **Property Tax Changes** | State/local adjustments | Effective carrying costs | Annual |
| **Building Code Changes** | Energy, accessibility requirements | Per-unit construction costs | 12-24 months |

#### Active Policy Risks to Monitor

Track these as binary event risks that could shift housing regimes:

| **Risk** | **Direction** | **Magnitude** | **Probability Proxy** |
|---|---|---|---|
| **GSE IPO / Privatization** | Ambiguous (higher rates, less access) | High | Presidential directives, FHFA commentary |
| **Fed MBS Outright Sales** | Bearish (wider spreads) | Medium | FOMC minutes, Fed speeches |
| **Federal SFR Purchase Ban** | Bearish SFR REITs, mildly bullish prices | Medium | Congressional legislation progress |
| **Tariff Escalation on Materials** | Bearish supply | Medium-High | Trade policy announcements |
| **Immigration Enforcement** | Bearish construction labor | High | ICE enforcement data, construction wage data |
| **SALT Cap Modification** | Bullish high-tax state housing | Medium | Tax legislation negotiations |
| **Government MBS Purchase Program** | Bullish (spread compression) | Medium-High | Administrative proposals |

---

### K. DEMOGRAPHICS & HOUSEHOLD FORMATION (The Structural Demand Floor)

Demographics are the slowest-moving but most powerful housing variable. They set the demand floor regardless of cyclical conditions.

| **Indicator** | **Source** | **Frequency** | **Interpretation** |
|---|---|---|---|
| **Household Formation Rate** | Census (CPS/ASEC) | Annual | Demand driver for new housing units |
| **Population Growth Rate** | Census | Annual | Baseline demand growth |
| **Population: 25-34 Age Cohort** | Census | Annual | First-time buyer demographic |
| **Population: 35-44 Age Cohort** | Census | Annual | Move-up buyer demographic |
| **Millennial Homeownership Rate** | Census (CPS/HVS) | Quarterly | Generational penetration |
| **Overall Homeownership Rate** | RHORUSQ156N | Quarterly | Structural ownership demand |
| **Marriage Rate** | CDC NVSS | Annual | Household formation catalyst |
| **Divorce Rate** | CDC NVSS | Annual | Unit demand multiplier |
| **Net Immigration** | Census / CBO | Annual | Population growth driver |
| **Headship Rate (by age)** | Census | Annual | Share of population forming households |
| **Multigenerational Living Share** | Census (ACS) | Annual | Compressed household formation |
| **Boomer Estate/Downsizing Wave** | Census + modeling | Structural | Silver tsunami supply addition |

#### Key Demographic Facts (Reference)

- Millennials (b. 1981-1996): 72M strong. Peak homebuying years (29-44 in 2025). Homeownership rate 55.4% vs 63-66% for prior generations at same age.
- Only 33% owned homes at age 30 vs 42% (Gen X) and 48% (Boomers). Delayed, not eliminated.
- 3M additional households aged 35-54 projected to form 2025-2035 (JCHS).
- 98% of net household growth is minority/diverse households.
- Boomers hold ~33M owner-occupied units. The "silver tsunami" is a decade-long supply story, not an event.

#### Derived Demographic Metrics

| **Metric** | **Formula** | **Threshold** | **Signal** |
|---|---|---|---|
| **Formation-Construction Gap** | HH Formation - Housing Completions | >+200k/yr | Structural undersupply |
| **Millennial Ownership Gap** | Prior Gen Rate (at same age) - Millennial Rate | >+8 ppts | Pent-up demand |
| **Immigration-Adjusted Demand** | Net Immigration × Headship Rate | Declining | Demand headwind |
| **Boomer Exit Rate** | Boomers 75+ (annual change) × Downsizing Rate | Accelerating | Supply tailwind (long lag) |
| **Gen Z Entry Rate** | Gen Z 25-29 × Historical First-Time Rate | Rising | Next demand wave |

---

### L. CONSTRUCTION COSTS & LABOR (The Supply Constraint)

When it costs more to build, fewer units get built, existing inventory becomes more valuable, and the structural deficit widens.

| **Indicator** | **Source** | **Frequency** | **Interpretation** |
|---|---|---|---|
| **Construction Cost Index** | Turner/RS Means | Quarterly | All-in construction cost benchmark |
| **Census Construction Spending (Residential)** | Census | Monthly | Dollar volume of construction activity |
| **PPI: Inputs to Residential Construction** | BLS | Monthly | Material costs |
| **PPI: Gypsum Products** | BLS | Monthly | Interior finishing cost |
| **PPI: Lumber & Wood Products** | BLS | Monthly | Framing cost |
| **PPI: Ready-Mix Concrete** | BLS | Monthly | Foundation cost |
| **Avg Hourly Earnings: Construction** | BLS (CES) | Monthly | Labor cost pressure |
| **Construction Employment** | BLS (CES) | Monthly | Sector employment health |
| **Construction Job Openings** | BLS (JOLTS) | Monthly | Labor tightness |
| **Construction Quits Rate** | BLS (JOLTS) | Monthly | Worker confidence / mobility |
| **Residential Building Permits per Worker** | Derived | Monthly | Productivity proxy |
| **Lot Prices** | Census / NAHB | Quarterly | Land cost component |

#### Tariff Impact Matrix

| **Material** | **Import Share** | **Current Tariff** | **Est. Cost Impact Per Unit** |
|---|---|---|---|
| **Canadian Softwood Lumber** | ~30% of domestic consumption | 35.2% countervailing duty | +$5,000-$8,000 |
| **Steel (structural)** | ~25% imported | 50% (Section 232 + reciprocal) | +$3,000-$5,000 |
| **Aluminum** | ~40% imported | 25% (Section 232) | +$1,000-$2,000 |
| **Copper (wiring, plumbing)** | ~40% imported | 25%+ (pending) | +$1,500-$3,000 |
| **Chinese Fixtures/Cabinets** | Significant market share | 50%+ (Section 301 + reciprocal) | +$2,000-$4,000 |
| **Appliances** | Mixed | 10-50% (varies) | +$500-$2,000 |
| **TOTAL TARIFF IMPACT** | --- | --- | **+$10,000-$20,000+ per unit** |

#### Derived Cost Metrics

| **Metric** | **Formula** | **Threshold** | **Signal** |
|---|---|---|---|
| **Construction Cost YoY%** | Current Index - Year Ago | >+8% | Cost inflation acute |
| **Lumber-to-Home Price Ratio** | Lumber / Median New Home Price × 1000 | >2.0 | Lumber driving cost pressure |
| **Construction Wage vs Avg Wage** | Const AHE / Total Private AHE | >1.10x | Construction premium elevated |
| **Labor Tightness** | Const Openings / Const Hires | >1.5x | Severe labor shortage |
| **Cost-Price Gap** | Construction Cost YoY - New Home Price YoY | >+3 ppts | Margin compression risk |
| **Tariff Cost Burden** | Est. Tariff Impact / Median New Home Price | >3% | Material affordability impact |


---

## Housing Composite Index (HCI) v2.0

The HCI synthesizes all housing sub-indicators into a single regime score. It draws from every section above, weighted by predictive power and signal reliability.
...
Housing doesn't exist in isolation. It is deeply intertwined with every other pillar in the framework.

### Housing → Other Pillars

| **Target Pillar** | **Transmission Channel** | **Lead Time** | **Key Metric** |
|---|---|---|---|
| **Pillar 1: Labor** | Construction employment, real estate services, mortgage jobs | 2-4 months | Residential construction employment YoY |
| **Pillar 2: Prices** | Shelter CPI (34% of CPI), OER methodology lag | **12-18 months** | Zillow ZORI → CPI Shelter (lagged predictor) |
| **Pillar 3: Growth** | Residential fixed investment (~4% of GDP), wealth effect on consumption | 3-6 months | Residential investment contribution to GDP |
| **Pillar 4 → 5: Consumer** | Wealth effect ($1 equity → $0.05-0.08 spending), HELOC/cash-out spending | 3-6 months | Home equity change → retail sales |
| **Pillar 4 → 6: Business** | Construction-related capex, building materials demand | 4-8 months | Residential construction spending |
| **Pillar 4 → 9: Financial** | Mortgage credit quality, bank balance sheets, MBS markets | 6-12 months | Delinquency rates → bank net charge-offs |
| **Pillar 4 → 10: Plumbing** | MBS supply/demand, Fed MBS QT, agency spread dynamics | 1-4 weeks | MBS OAS, Fed H.4.1 MBS holdings |
| **Pillar 4 → 11: Structure** | Homebuilder equities, REIT performance, MBS ETFs | Days-weeks | XHB relative strength, sector rotation |

### Other Pillars → Housing

| **Source Pillar** | **Transmission Channel** | **Lead Time** | **Key Metric** |
|---|---|---|---|
| **Pillar 1: Labor → 4** | Employment drives income, income drives affordability | 3-6 months | Payrolls growth, wage growth |
| **Pillar 2: Prices → 4** | Inflation drives Fed policy, Fed drives mortgage rates | 6-12 months | Core PCE → Fed rate path → mortgage rates |
| **Pillar 3: Growth → 4** | GDP growth supports confidence, income, demand | 3-6 months | GDP growth, consumer confidence |
| **Pillar 8: Government → 4** | Fiscal policy (tax credits, subsidies, SALT), Treasury issuance → rates | Structural | First-time buyer credits, GSE policy |
| **Pillar 9: Financial → 4** | Bank lending standards, credit availability, mortgage spreads | 3-6 months | SLOOS residential standards, MCAI |
| **Pillar 10: Plumbing → 4** | Reserve scarcity → wider spreads → higher rates → lower demand | 1-4 weeks | LCI → mortgage spread → affordability |
| **Pillar 12: Sentiment → 4** | Consumer confidence, homebuyer sentiment | 2-4 months | UMich homebuying conditions, NAHB traffic |

### The Shelter-CPI Feedback Loop

This is the single most important cross-pillar relationship in the current macro regime:

```
Market Rents (Zillow ZORI) → 12-18 month lag → CPI Shelter (OER + Rent of Primary Residence)
    → CPI Shelter = 34% of CPI, 18% of Core PCE
    → Core PCE drives Fed rate decisions
    → Fed rate decisions drive mortgage rates
    → Mortgage rates drive housing affordability
    → Affordability drives housing demand
    → Demand drives market rents (COMPLETING THE LOOP)
```

**The Insight:** Market rents peaked in early 2022. CPI Shelter didn't peak until early 2024. The disinflation embedded in market rents from 2022-2024 is still feeding through. If you know today's Zillow ZORI, you have a reasonable estimate for CPI Shelter 12-18 months hence. This is the most reliably predictive relationship in the entire inflation framework.
